...
<head>
    ...
    <title>@yield('title') | Admin FIT TRACK</title>
...
<style>
    ...
    /* Jika ingin mengganti warna navbar juga */
    .main-header {
        background-color: #28a745 !important; /* Warna hijau navbar */
    }

    /* Jika ingin mengganti warna header sidebar */
    .brand-link {
        background-color: #28a745 !important; /* Warna hijau header */
    }
</style>
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="/dashboard" class="brand-link">
                ...
                <span class="brand-text font-weight-light">Admin FIT TRACK</span>
            </a>
